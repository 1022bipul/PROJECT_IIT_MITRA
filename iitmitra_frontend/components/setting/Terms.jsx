<div className="flex flex-col items-center justify-center bg-gray-800 overflow-y-scroll">
    <div className=" flex flex-col items-center justify-center bg-gray-300 size-fit w-4xl m-1 mb-5 pt-5 p-10 rounded-full transform hover:scale-105 hover:bg-white hover:shadow-md shadow-blue-500 hover:mt-2 transition duration-500 ease-in-out opacity-125  ">
    ...
    <div className="flex justify-center items-center">
        <div className="flex flex-col justify-center items-center bg-gray-300 size-fit w-4xl m-1 mr-10 pt-3 p-12 rounded-full transform hover:scale-105 hover:bg-white hover:shadow-md shadow-blue-500 hover:mt-2 transition duration-500 ease-in-out opacity-125">
...
<img src="https://images.pexels.com/photos/1516440/pexels-photo-1516440.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" className="size-70 rounded-full mt-5 mb-5 mr-10"/>
    <div className="flex flex-col justify-center items-center bg-gray-300 size-fit w-4xl m-1 pt-5 p-10 rounded-full transform hover:scale-105 hover:bg-white hover:shadow-md shadow-blue-500 hover:mt-2 transition duration-500 ease-in-out opacity-125">
    ...
    <div className="flex justify-center items-center">
        <div className="flex flex-col justify-center items-center bg-gray-300 size-fit w-4xl m-1 mb-5 mr-10 pt-5 p-10 rounded-full transform hover:scale-105 hover:bg-white hover:shadow-md shadow-blue-500 hover:mt-2 transition duration-500 ease-in-out opacity-125">
    ...
    <div className="flex justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center bg-gray-300 size-fit w-4xl m-5 ml-10 pt-5 p-10 rounded-full transform hover:scale-105 hover:bg-white hover:shadow-md shadow-blue-500 hover:mt-2 transition duration-500 ease-in-out opacity-125">
